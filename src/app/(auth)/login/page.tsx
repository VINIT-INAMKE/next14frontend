      ...
      >
        <div className="w-full max-w-md">
          <div className="bg-white rounded-xl shadow-lg border border-blue-200 overflow-hidden">
            ...
            <div className="h-2 bg-gradient-to-r from-blue-800 to-blue-600" />

            <div className="p-8 space-y-6">
              <div className="text-center space-y-2">
                <LockClosedIcon className="h-8 w-8 text-blue-800 mx-auto" />
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-blue-50 border border-blue-200 rounded-lg px-4 py-3 
                             placeholder-blue-300 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                ...
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-blue-800 to-blue-600 text-white 
                           ...
                           hover:from-blue-900 hover:to-blue-700 relative"
                >
                  {isLoading ? (
              ...
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full flex items-center justify-center gap-3 bg-blue-50 text-blue-800 
                         rounded-lg p-3 border border-blue-200 hover:bg-blue-100 transition-colors"
              >
          ...
          <p className="mt-4 text-center text-blue-600">
            ...
            <Link
              href="/register"
              className="font-medium hover:text-blue-800 transition-colors duration-300"
            >
              Register now
            </Link>
          </p>
