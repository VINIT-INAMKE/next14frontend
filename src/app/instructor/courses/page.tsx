                            ...
                            >
                              ...
                              <td className="px-6 py-4">
                                <div className="flex space-x-2">
                                  <Button variant="outline" size="icon" className="h-8 w-8 text-buttonsCustom-600" asChild>
                                    <Link href={`/instructor/edit-course/${course.course_id}/`}>
                      ...
                      {courses.map((course) => (
                        ...
                        >
                          ...
                          <div className="flex space-x-2 pt-2 border-t border-gray-100">
                            <Button variant="outline" size="sm" className="flex-1 h-8 text-buttonsCustom-600" asChild>
                              <Link href={`/instructor/edit-course/${course.course_id}/`}>
